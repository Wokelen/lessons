...
from my_lessons.HW_18_hard.hard.dao.model.movie import MovieSchema
from my_lessons.HW_18_hard.hard.implemented import movie_service
...
class MoviesView(Resource):
    ...
    def post(self):
        ...
        return "User is created", 201, {"location": f"/movies/{movie.id}"}
