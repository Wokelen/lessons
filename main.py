...
def movie_page(title):
    ...
    data = utils.choose_title(recieved_data)
    return data
...
def search_page():
    ...
    data = utils.find_movies(int(recieved_data_1), int(recieved_data_2))
    return data
...
def children_page():
    data = utils.conv_for_child()
    return data


@app.route('/rating/family/')
def family_page():
    data = utils.conv_for_family()
    return data


@app.route('/rating/adult/')
def adult_page():
    data = utils.conv_for_adult()
    return data
...
def genre_page(genre):
    ...
    data = utils.choose_genre(recieved_data)
    return data
